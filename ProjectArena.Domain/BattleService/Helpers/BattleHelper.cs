            ...
            {
                {
                    GameMode.Patrol, new SceneModeQueue()
                    {
                        ...
                        Mode = new SceneMode()
                        {
                            ...
                            VarManager = EngineHelper.CreateVarManager(30, false, 8, 16, 0.05f, 0.05f, 0.03f, 0.4f),
                ...
                },
                {
                    GameMode.BotLearning, new SceneModeQueue()
                    {
                        ...
                        {
                            Generator = EngineHelper.CreateDuelSceneGenerator(),
                            VarManager = EngineHelper.CreateVarManager(30, true, 8, 16, 0.05f, 0.05f, 0.03f, 0.4f),
                            BattleResultProcessor = BattleResultProcessors.ProcessMainDuelBattleResult,
                            MaxPlayers = 2,
                            TimeTillBot = 0,
                            BotsOnly = true,
