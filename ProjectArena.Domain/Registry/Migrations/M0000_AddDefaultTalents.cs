        ...
        public void Up(RegistryContext context)
        {
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Ranger,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Mistwalk\" ability. Teleports within a range of 8. Costs 1 action point. Recharges in 5 turns.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Architect,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Barrier\" ability. Creates a barrier within a range of 4. Costs 3 action points. Can be cast every turn.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Architect,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Place of power\" ability. Transforms a cell within a range of 4 to a place of power that increases strength and willpower by 200%. Costs 3 action points. Recharges in 6 turns.",
