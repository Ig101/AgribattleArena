        ...
        public void Up(RegistryContext context)
        {
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Fighter,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Warden\" ability. Replaces \"Magic missle\" with shield throw that deals increased strength-based damage within a range of 6.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Enchanter,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Empower\" ability. Increases target's damage by 50% of willpower modifier for 3 rounds. Costs 3 action points. Recharges in 8 turns.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    ClassPoints = 1,
                    UniqueDescription = "Replaces attack with the range one that deals slightly less damage within a range of 8.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Ranger,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Mistwalk\" ability. Teleports within a range of 10. Costs 1 action point. Recharges in 5 turns.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Architect,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Barrier\" ability. Creates a barrier within a range of 4. Costs 2 action points. No cooldown.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Mistcaller,
                    ClassPoints = 1,
                    UniqueDescription = "Replaces attack with the range one that deals willpower-based damage within a range of 6. Can be cast on the targets behind obstactles.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Architect,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Place of power\" ability. Transforms a cell within a range of 4 to a place of power that increases strength and willpower by 200%. Costs 3 action points. Recharges in 3 turns.",
