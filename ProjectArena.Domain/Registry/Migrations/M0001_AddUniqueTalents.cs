        ...
        public void Up(RegistryContext context)
        {
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Fighter,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Leap\" ability. Leaps to the position within a range of 3 and deal small damage to all surrounding objects. Costs 3 action points. Recharges in 3 turns.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Fighter,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Warden\" ability. Replaces \"Magic missle\" with weapon throw that deals strength-based damage within a range of 3.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Ranger,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Shadowstep\" ability. Teleports within a range of 4. Costs 1 action point. Recharges in 3 turns.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Architect,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Place of power\" ability. Transforms a cell within a range of 4 to a place of power that increases all outcoming magic damage for 100%. Costs 4 action points. Recharges in 3 turns.",
            ...
            context.TalentMap.ReplaceOne(
                ...
                new TalentNode()
                {
                    ...
                    Class = CharacterClass.Enchanter,
                    ClassPoints = 1,
                    UniqueDescription = "Learns the \"Armaments\" ability. Increases organic target's damage using magic damage modifier up to 50% for 3 turns. Costs 6 action points. Recharges in 4 turns.",
