...
export interface IModalConstructorWithoutArgs<Tout, TComponent extends IModal<Tout>> extends ComponentType<TComponent> {
  new (overlayRef: OverlayRef, ...args: any[]): TComponent;
}
